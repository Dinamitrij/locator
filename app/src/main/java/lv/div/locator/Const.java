...
public class Const {
    ...
    public static final String REPORT_URL_MASK = "http://api.thingspeak.com/update?key=XCFK6A93DMV9FUQ2&field1=%s&field2=%s&field3=%s&field4=%s&field5=%s&field6=%s&field8=%s";
