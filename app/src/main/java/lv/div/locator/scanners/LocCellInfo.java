package lv.div.locator.scanners;
...
public class LocCellInfo implements Parcelable {
    ...
    protected LocCellInfo(Parcel in) {
    ...
    public static final Creator<LocCellInfo> CREATOR = new Creator<LocCellInfo>() {
        @Override
        public LocCellInfo createFromParcel(Parcel in) {
            return new LocCellInfo(in);
        }

        @Override
        public LocCellInfo[] newArray(int size) {
            return new LocCellInfo[size];
        }
    };
    ...
    /*
     This constructor is only used when building LocCellInfo for a neighbouring cell.
     */
    public LocCellInfo(NeighboringCellInfo nci, String networkOperator) {
        reset();
...
//                Log.e(LOG_TAG, "", new IllegalArgumentException("Unexpected phone type: " + phoneType));
    ...
    public JSONObject toJSONObject() {
        ...
        try {
            ...
            if (mSignalStrength != UNKNOWN_SIGNAL_STRENGTH)
                obj.put("signalStrength", mSignalStrength);
    ...
    public void setCdmaCellInfo(int baseStationId, int networkId, int systemId, int dbm) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LocCellInfo)) {
            return false;
        }
        LocCellInfo ci = (LocCellInfo) o;
